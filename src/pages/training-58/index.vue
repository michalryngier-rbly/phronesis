    ...
    <v-row>
      ...
      <v-col cols="12">
        <phronesis-card
          ...
          confusing
        >
          Should it be called ‘sessions’ too? (same as the unit label)
      ...
      <v-col cols="12">
        <phronesis-card
          ...
          suggestion
        >
          We might use unit label in the invoice (sessions in this case) instead of ‘units’.
